//
//  ofxOssiaParamNode.hpp
//  example-singleServer
//
//  Created by Pascal Baltazar on 04/08/2018.
//

#ifndef ofxOssiaParamNode_hpp
#define ofxOssiaParamNode_hpp

#include <ofxOssiaNode.h>

template<typename DataValue>
class ofxOssiaParamNode : public ofxOssiaNode {
...
public:
    ...
    s
    ofxOssiaNode& setTags(const std::vector<std::string>& attrVal) {getNode().set_tags(attrVal); return *this; }
